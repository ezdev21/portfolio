...
function Footer() {
  ...
  return (
    <div className="bg-[#0A0416] py-[30px] px-4 md:px-10 bottom-0">
      <div className="md:flex items-end">
        <div className="md:w-1/2 md:text-center">
          <div className="text-white md:flex flex-col items-start">
            <h3 className="text-white font-medium pb-2 text-2xl">Get in touch!</h3>
            <h6 className="text-start text-sm md:text-sm font-light">My inbox is always open. Whether you have a question or just want to say hello, I will try my best to get back to you!</h6>
          </div>
        </div>
        <div className="text-white md:w-1/4 md:text-center text-xs md:text-sm py-3">
