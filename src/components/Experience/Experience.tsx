...
export default function Experience() {
  ...
  return (
    <motion.section variants={sectionVariants} exit="exit">
      <div className="relative bg-no-repeat py-[30px] px-[70px] -z-1 bg-[linear-gradient(to_bottom_left,rgba(17,16,16,0.678),rgba(12,10,22,0.863))] bg-position-[top_center]">
        <div className="text-left text-[whitesmoke] pt-36 pb-8 px-0">
          ...
          <motion.div variants={variants} initial="initial" whileInView="animate" viewport={{ once: true }}  whileHover="hover" whileTap="tap" exit="exit">
            <div className="p-5 my-10 text-white bg-transparent h-full opacity-90 transition-all duration-500 ease-linear shadow-[0_4px_5px_3px_rgba(119,53,136,0.459)]">
              <div>
                <h2 className="font-bold text-4xl my-2">HADDIS ART</h2>
                <h6 className="my-2">Full-stack Developer Feb 2025 - Aug 2025</h6>
                <hr className="my-3 border-gray-300 border-t-3 opacity-25"/>
                <ul className="p-0 font-light text-lg text-left list-disc">
          ...
          <motion.div variants={variants} initial="initial" whileInView="animate" viewport={{ once: true }}  whileHover="hover" whileTap="tap" exit="exit">
            <div className="p-5 my-10 text-white bg-transparent h-full opacity-90 transition-all duration-500 ease-linear shadow-[0_4px_5px_3px_rgba(119,53,136,0.459)]">
              <div>
                <h2 className="font-bold text-4xl my-2">BIRITU DIGITAL SAVING AND COOP</h2>
          ...
          <motion.div variants={variants} initial="initial" whileInView="animate" viewport={{ once: true }}   whileHover="hover" whileTap="tap" exit="exit">
            <div className="p-5 my-10 text-white bg-transparent h-full opacity-90 transition-all duration-500 ease-linear shadow-[0_4px_5px_3px_rgba(119,53,136,0.459)]">
              <div>
                <h2 className="font-bold text-4xl my-2">POOL TAXI</h2>
          ...
          <motion.div variants={variants} initial="initial" whileInView="animate" viewport={{ once: true }}   whileHover="hover" whileTap="tap" exit="exit">
            <div className="p-5 my-10 text-white bg-transparent h-full opacity-90 transition-all duration-500 ease-linear shadow-[0_4px_5px_3px_rgba(119,53,136,0.459)]">
              <div>
                <h2 className="font-bold text-4xl my-2">MADOT SOLUTIONS</h2>
                <h6 className="my-2">Full-stack Developer Dec 2021 - Sep 2022</h6>
                <hr className="my-3 border-gray-300 border-t-3 opacity-25"/>
                <ul className="p-0 font-light text-lg text-left my-5 list-disc">
          ...
          <motion.div variants={variants} initial="initial" whileInView="animate" viewport={{ once: true }}   whileHover="hover" whileTap="tap" exit="exit">
            <div className="p-5 my-10 text-white bg-transparent h-full opacity-90 transition-all duration-500 ease-linear shadow-[0_4px_5px_3px_rgba(119,53,136,0.459)]">
              <div>
                <h2 className="font-bold text-4xl my-2">BOTAYE DATA SCIENCE</h2>
